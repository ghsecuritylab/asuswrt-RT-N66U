...
<tbody>
		...
		<tr>
			...
			<td>
				<input type="text" maxlength="15" class="input_15_table" name="wl_radius_ipaddr" value="<% nvram_get("wl_radius_ipaddr"); %>" onKeyPress="return is_ipaddr(this)" onKeyUp="change_ipaddr(this)" onblur="valid_IP_form(this, 0)">
			</td>
		</tr>
		<tr>
			<th>
			...
			<td>
				<input type="text" maxlength="5" class="input_6_table" name="wl_radius_port" value="<% nvram_get("wl_radius_port"); %>" onkeypress="return is_number(this)" onblur="validate_number_range(this, 0, 65535)"/>
			</td>
		</tr>
		<tr>
			<th >
