...
function edit_Row(r){ 	
	...
	document.form.autofw_inproto_x_o.value = $('autofw_rulelist_table').rows[i].cells[3].innerHTML;
	...
	<tr>
		...
		<div class="formfontdesc"><#IPConnection_porttrigger_sectiondesc#></div>
          ...
          <table width="100%" border="1" align="center" cellpadding="4" cellspacing="0"  class="FormTable_table">
	          ...
	          <tr>
          		<td width="22%">
              		<input type="text" maxlength="18" class="input_15_table" name="autofw_desc_x_0" onKeyPress="return is_string(this)">
            	</td>
            	<td width="21%">            		
              		<input type="text" maxlength="5" class="input_6_table"  name="autofw_outport_x_0" onKeyPress="return is_portrange(this)"><!-- onblur="validate_number_range(this, 1, 65535);"-->
            	</td>
            	<td width="10%">
            	...
            	<td width="21%">
              		<input type="text" maxlength="5" class="input_6_table" name="autofw_inport_x_0" onKeyPress="return is_portrange(this)"><!-- onblur="validate_number_range(this, 1, 65535);"-->
            	</td>
            	<td width="10%">
