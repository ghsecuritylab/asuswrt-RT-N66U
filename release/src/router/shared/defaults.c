...
#else
	{ "wl_mrate", "12000000" },		/* default setting of SDK 5.110.27.0 */
#endif
#else
//	{ "wl_mrate_x", "7" },			/* 12 Mbps */
	{ "wl_mrate_x", "0" },
#endif
#else
...
#if defined (RTCONFIG_WIRELESSREPEATER) || defined (RTCONFIG_PROXYSTA) || defined (RTCONFIG_W3N)
	{ "wlc_list",			""	},
#ifndef RTCONFIG_W3N
	{ "wlc_band",			""	},
#else
