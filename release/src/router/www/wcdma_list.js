function show_wcdma_country_list(){
	...
	countrylist[5] = new Array("Czech", "CZ");
	countrylist[6] = new Array("Dominican Republic", "DR");
	countrylist[7] = new Array("Denmark", "DK");
	countrylist[8] = new Array("Germany", "DE");
	countrylist[9] = new Array("Egypt", "EG");
	countrylist[10] = new Array("El Salvador", "SV");
	countrylist[11] = new Array("Finland", "FI");
	countrylist[12] = new Array("Hong Kong", "HK");
	countrylist[13] = new Array("Indonesia", "IN");
	countrylist[14] = new Array("India", "INDI");
	countrylist[15] = new Array("Italy", "IT");
	countrylist[16] = new Array("Japan", "JP");
	countrylist[17] = new Array("Malaysia", "MA");
	countrylist[18] = new Array("Netherland", "NE");
	countrylist[19] = new Array("Norway", "NO");
	countrylist[20] = new Array("New Zealand", "NZ");
	countrylist[21] = new Array("Portugal", "PO");
	countrylist[22] = new Array("Poland", "POL");
	countrylist[23] = new Array("Philippine", "PH");
	countrylist[24] = new Array("Romania", "RO");
	countrylist[25] = new Array("Russia", "RU");
	countrylist[26] = new Array("Singapore", "SG");
	countrylist[27] = new Array("South Africa", "SA");
